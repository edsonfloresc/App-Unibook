...
namespace WebCategoryListService
{
    ...
    public partial class CategoryDto : object
    {
        ...
        private WebCategoryListService.QuestionsDto QuestionsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public WebCategoryListService.QuestionsDto Questions
        {
            get
            {
    ...
    public partial class GetResponseBody
    {
        ...
        public WebCategoryListService.CategoryDto[] GetResult;
        
        public GetResponseBody()
        {
        }
        
        public GetResponseBody(WebCategoryListService.CategoryDto[] GetResult)
        {
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        public WebCategoryListService.CategoryDto[] Get()
        {
            WebCategoryListService.GetRequest inValue = new WebCategoryListService.GetRequest();
            inValue.Body = new WebCategoryListService.GetRequestBody();
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.WebCategoryListServiceSoap))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:29357/WebCategoryListService.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.WebCategoryListServiceSoap12))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:29357/WebCategoryListService.asmx");
